"""
File name: preprocessing_dfdc.py
Author: Tomas Lapsansky (xlapsa00@stud.fit.vutbr.cz)
Description: This file is used for preprocessing the DFDC dataset.
"""
...
base_path = '/storage/brno12-cerit/home/xlapsa00/datasets/DFDC_images/test'
dataset_path = '/storage/brno12-cerit/home/xlapsa00/datasets/DFDC_dataset'


def parse_args():
    parser = argparse.ArgumentParser(description='Preprocess images from DFDC')
...
def cut_faces():
    ...
    print(f'Done with converting: {stats}')
